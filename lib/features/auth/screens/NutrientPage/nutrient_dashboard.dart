...
class NutrientDashboardPage extends StatefulWidget {
  const NutrientDashboardPage({super.key});

  @override
  State<NutrientDashboardPage> createState() => _MedicineDashboardPageState();
}

class _MedicineDashboardPageState extends State<NutrientDashboardPage> {
